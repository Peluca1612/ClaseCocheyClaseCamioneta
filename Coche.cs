namespace In_out
{
    class Coche
    {
        ...
        public void SetPesoCarroceria(int pc) { this.PesoCarroceria = pc; }
        ...
        {
            string exit = $"Este carro tiene {this.Ruedas} ruedas, y su plataforma pesa {this.PesoCarroceria}. Sus dimensiones son {this.Dimensiones}. Tiene el motor {this.Motor}";
